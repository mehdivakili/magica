;(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        _initPen: function (canvas) {
            ...
            this.gradient = this.pen.createLinearGradient(0, 0, 150, 100);
            this.gradient .addColorStop("0.0" ,"rgb(1, 173, 238)");
            this.gradient .addColorStop("0.75", "rgb(146, 39, 143)");
        ...
        _drawCountdownLabel: function (secondsElapsed) {
            ...
            if (drawLabel) {
                ...
                y = this.settings.height / 2 + 5/* + (this.settings.fontSize / 6.2)*/;
            }

            this.pen.fillStyle = this.gradient;

            // this.pen.fillStyle = this.settings.fillStyle;
            //this.pen.fillText(this._faNumber(secondsLeft + 1), x, y);
            //this.pen.fillStyle = this.settings.fontColor;
            this.pen.fillText(this._faNumber(secondsLeft), x, y);
            if (drawLabel) {
                this.pen.font = "normal small-caps " + (this.settings.fontSize / 3) + "px " + this.settings.fontFamily;
                this.pen.fillText(this._faNumber(label), this.settings.width / 2, this.settings.height / 2 + (this.settings.fontSize / 2.2));
            }
        },
        ...
        _drawCountdownShape: function (endAngle, drawStroke) {
            ...
            this.pen.strokeStyle = this.gradient;
            this.pen.fillStyle = this.settings.fillStyle;
